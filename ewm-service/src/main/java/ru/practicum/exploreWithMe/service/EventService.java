...
public interface EventService {
    ...
    List<EventCommentDto> getEventComments(Long eventId, Pageable pageable);

    EventCommentDto publishComment(Long commentId);

    void deleteEventCommentByAdmin(Long commentId);
